...
TEST(Spectest, linear_memory_load_0_wasm) {
  ...
  EXPECT_EQ(wasm_as_br_value(), (static_cast<int32_t>(0x00ULL)));
  wasm_as_br_if_cond();
  EXPECT_EQ(wasm_as_br_if_value(), (static_cast<int32_t>(0x00ULL)));
  EXPECT_EQ(wasm_as_br_if_value_cond(), (static_cast<int32_t>(0x07ULL)));
  EXPECT_EQ(wasm_as_return_value(), (static_cast<int32_t>(0x00ULL)));
  EXPECT_EQ(wasm_as_if_cond(), (static_cast<int32_t>(0x01ULL)));
  EXPECT_EQ(wasm_as_if_then(), (static_cast<int32_t>(0x00ULL)));
  EXPECT_EQ(wasm_as_if_else(), (static_cast<int32_t>(0x00ULL)));
  ...
  EXPECT_EQ(wasm_as_local_tee_value(), (static_cast<int32_t>(0x00ULL)));
  ...
  EXPECT_EQ(wasm_as_unary_operand(), (static_cast<int32_t>(0x20ULL)));
  EXPECT_EQ(wasm_as_binary_left(), (static_cast<int32_t>(0x0aULL)));
  EXPECT_EQ(wasm_as_binary_right(), (static_cast<int32_t>(0x0aULL)));
  EXPECT_EQ(wasm_as_test_operand(), (static_cast<int32_t>(0x01ULL)));
  ...
  EXPECT_THROW(wasm_address_as_param(static_cast<int32_t>(0xffffff00ULL)), std::runtime_error);
  EXPECT_THROW(wasm_address_as_param(static_cast<int32_t>(0xfffeULL)), std::runtime_error);
}
} // namespace