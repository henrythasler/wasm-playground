...
./tests/machinecode/linear-memory-data.0.o:     file format elf64-littleaarch64

SYMBOL TABLE:
0000000000000000 g     F .text	000000000000005c trap_handler
000000000000005c g     F .text	0000000000000084 read_byte
...
Contents of section .text:
 ...
 00a0 a90ac0f2 29697ff8 89fcff34 0a7094d2  ....)i.....4.p..
 00b0 ca16a0f2 aa0ac0f2 4a697fb8 4a050051  ........Ji..J..Q
 00c0 1f010a6b a8fbff54 29796838 e003092a  ...k...T)yh8...*
...
000000000000005c <read_byte>:
  ...
  a8:	34fffc89 	cbz	w9, 38 <trap_handler+0x38>
  ...
  c8:	38687929 	ldrb	w9, [x9, x8, lsl #0]
